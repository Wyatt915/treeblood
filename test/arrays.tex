...
\displaystyle {\dv{x} \left[\left.\prod_{i=1}^k f_i(x)\right.\right] = \sum_{j=1}^k\left(\left.f^\prime_j(x)\prod_\substack{i=1\\i\not=j}^kf_i(x)\right.\right)}
\end{array}
